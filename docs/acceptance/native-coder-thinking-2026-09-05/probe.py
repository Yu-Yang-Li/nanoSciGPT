...
output = root / "out/native-coder-thinking-20260905/run"
...
record = {"status": "started", "model": "openai/scnet/GLM-5.3", "data_identity": "handwritten teaching protein labels",
          ...
          "baseline_run": True, "max_tokens": 6000, "api_timeout_seconds": 90, "requested_thinking": "disabled_not_yet_verified",
...
try:
    ...
    model.extra_params = {"max_tokens": 6000, "timeout": 90, "num_retries": 0,
