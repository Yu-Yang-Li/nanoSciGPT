...
output = root / "out/native-api-20260905/coder-default-low"
...
record = {"status": "started", "model": "openai/gpt-6-astra", "data_identity": "handwritten teaching protein labels",
          ...
          "baseline_run": True, "max_tokens": 6000, "api_timeout_seconds": 90, "reasoning_effort": "low",
...
try:
    os.chdir(output)
    model = Model("openai/gpt-6-astra", weak_model="openai/gpt-6-astra")
    model.extra_params = {"max_tokens": 6000, "timeout": 90, "num_retries": 0, "reasoning_effort": "low"}
