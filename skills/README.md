...
3. [`nanoscigpt-scientific-language`](nanoscigpt-scientific-language/SKILL.md)：把同一思路迁移到蛋白质、DNA、SMILES、天气、晶体、三维结构、图像、光谱和连续物理场；蛋白质与DNA可接入FASTA，SMILES可接入学生自己的CSV，天气、图像、光谱、连续场和三维点集可接入带回归标签的NPZ数组。
